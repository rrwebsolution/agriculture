...
import { getManagePermission, getPermissionForPath, getUserPermissions, permissionMatches } from '../lib/permissions'
...
export default function RequireAuth({ children }: Props) {
  ...
  if (required) {
    ...
    const canAccess =
      permissionMatches(userPermissions, required) ||
      (!!managePermission && permissionMatches(userPermissions, managePermission))
