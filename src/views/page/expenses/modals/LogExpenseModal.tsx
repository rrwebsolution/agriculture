...
import axios from '../../../../plugin/axios' // Siguruha nga sakto ang path
        ...
        <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl flex flex-col max-h-[95vh] overflow-hidden border dark:border-slate-800 animate-in fade-in zoom-in-95 slide-in-from-bottom-8 duration-300">
            ...
            <div className="bg-primary p-6 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-4 text-white">
                    ...
                    <div>
                        <h2 className="text-lg font-black uppercase tracking-tight leading-none">Log New Expense</h2>
                ...
                <div className="p-8 sm:p-10 overflow-y-auto custom-scrollbar flex-1 space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <SearchableSelect 
                                        ...
                                        options={projects} defaultOptions={projects} 
                            ...
                            <div className="space-y-1.5 md:col-span-2">
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <input type="text" className={cn("w-full pl-11 pr-4 py-4 bg-gray-50 dark:bg-slate-800 border rounded-2xl text-sm font-bold outline-none uppercase", errors.item ? "border-red-500 focus:border-red-500" : "border-gray-300 dark:border-slate-700")} placeholder="e.g. Purchase of Rice Seeds" value={formData.item} onChange={(e) => { setFormData({...formData, item: e.target.value}); setErrors({...errors, item: ""}); }} />
                                </div>
                    ...
                    <div className="space-y-5">
                        <div className="flex items-center gap-2 text-primary">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-widest">2. Financial Metrics</span>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-1.5">
                                ...
                                <input type="number" step="0.01" className={cn("w-full px-4 py-4 bg-gray-50 dark:bg-slate-800 border rounded-2xl text-sm font-bold outline-none text-primary", errors.amount ? "border-red-500 focus:border-red-500" : "border-gray-300 dark:border-slate-700")} placeholder="0.00" value={formData.amount} onChange={(e) => { setFormData({...formData, amount: e.target.value}); setErrors({...errors, amount: ""}); }} />
                                {errors.amount && <p className="text-[9px] text-red-500 font-bold ml-1">{errors.amount}</p>}
                            </div>

                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Date Incurred <span className="text-red-500">*</span></label>
                                <div className="relative flex items-center">
                                ...
                                {errors.date && <p className="text-[9px] text-red-500 font-bold ml-1">{errors.date}</p>}
                            </div>

                            {/* PAYMENT STATUS - SEARCHABLE SELECT (UPWARDS) */}
                            <div className="space-y-1.5">
