    ...
    <div className="fixed inset-0 z-99 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="h-24 bg-primary relative">
           <button onClick={onClose} className="absolute top-4 right-4 p-2 bg-white/20 hover:bg-rose-500/20 hover:text-rose-400 rounded-full transition-all"><X size={18} /></button>
