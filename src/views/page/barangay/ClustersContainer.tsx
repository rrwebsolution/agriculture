                ...
                <tr key={cluster.id} className="group hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-all">
                  <td className="px-8 py-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-sm font-black text-gray-800 dark:text-slate-200 tracking-tight leading-tight">{cluster.name}</p>
                  ...
                  <td className="px-8 py-6 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button onClick={() => openViewModal(cluster)} className="p-2 text-gray-400 hover:text-primary transition-all cursor-pointer"><Eye size={16} /></button>
                      <button onClick={() => openEditModal(cluster)} className="p-2 text-gray-400 hover:text-blue-500 transition-all cursor-pointer"><Edit3 size={16} /></button>
                      <button onClick={() => handleDeleteCluster(cluster.id)} className="p-2 text-gray-400 hover:text-rose-500 transition-all cursor-pointer"><Trash2 size={16} /></button>
                    </div>
                  </td>
                </tr>
              ))) : (
