...
const FarmerMetricCard: React.FC<FarmerMetricCardProps> = ({ 
  ...
  if (isLoading) {
    return (
      <div className="relative p-6 pl-8 bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-[1.5rem] flex items-center gap-4 shadow-sm overflow-hidden h-28">
        ...
        <div className="w-14 h-14 rounded-2xl bg-gray-200 dark:bg-slate-800 animate-pulse shrink-0 opacity-60" />
        <div className="space-y-2 w-full">
          <div className="h-2.5 bg-gray-200 dark:bg-slate-800 rounded animate-pulse w-28" />
          <div className="h-6 bg-gray-200 dark:bg-slate-800 rounded animate-pulse w-16" />
          <div className="h-2.5 bg-emerald-100 dark:bg-emerald-500/10 rounded animate-pulse w-24" />
        </div>
      </div>
    );
  }
...
export default FarmerMetricCard;
