                  ...
                  <tr key={rep.id} className="group hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-all">
                    ...
                    <td className="px-8 py-6 align-middle text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <button type="button" onClick={() => onDelete(rep.id)} title="Delete Report" className="p-2.5 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl transition-all cursor-pointer">
                          <Trash2 size={16} />
                        </button>
                      </div>
                    </td>
